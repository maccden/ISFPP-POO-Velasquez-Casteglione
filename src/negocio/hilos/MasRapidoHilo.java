...
/**
 * Clase que representa un hilo para calcular la ruta más rápida en segundo
 * plano
...
public class MasRapidoHilo extends SwingWorker<Void, Void> {
    ...
    /**
     * Constructor de la clase MasRapidoHilo.
     *
     * @param trayecto    El trayecto para el cálculo de la ruta más rápida.
    ...
    public Void doInBackground() {
        ...
        // Si la tarea no ha sido cancelada, realiza el cálculo de la ruta más rápida.
        if (!this.isCancelled())
